...
public class SchoolOverallTeacherPerformanceInterFace {
	private final Scanner sc;

	public SchoolOverallTeacherPerformanceInterFace(Scanner sc) {
		this.sc = sc;
	}
	...
	public void printOverallSummary(OverallTeacherPerformanceSummary summary) {
	...
	public void printExamTypeOverallPerformance(OverallTeacherPerformance performance) {
